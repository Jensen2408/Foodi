          ...
          {recipe && (
            <div className="my-4 p-4 bg-gradient-to-br from-orange-50 to-pink-50 rounded-2xl border border-orange-100 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                ...
                {recipe.cookTime && <span className="flex items-center gap-1 bg-white px-2.5 py-1 rounded-full shadow-sm"><Clock className="w-3 h-3 text-[#c6185c]" /> {recipe.cookTime}m cook</span>}
